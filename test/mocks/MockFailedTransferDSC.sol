...
contract MockFailedTransfer is ERC20Burnable, Ownable {
    ...
    */
    ...
    /**
     * @notice Creates a new mock DSC token that fails transfers
     ...
     * @dev Used in DSCEngineTest.testRevertsIfTransferFails()
     * @return false Always returns false to simulate transfer failure
     */
